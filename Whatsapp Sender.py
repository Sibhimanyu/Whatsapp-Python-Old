...
# Function to send a Facebook message (WhatsApp)
...
def edit_parameters(template_label, term_label, date_label):
    ...
    available_templates = ["hostel_due_fees_tamil", "school_due_fees_tamil", "transport_due_fees_tamil", "last_year_due_fees_tamil"]  # Add your available template names here
    option_menu_template = ctk.CTkOptionMenu(params_window, values=available_templates)
